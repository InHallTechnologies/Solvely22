  ...
  render() {
    return (
      <div className="about-us">
        ...
        <h1 className="title">
          <span className="brown">About</span> <span className="blue">Us</span>
        </h1>
    ...
    Solvely.22 is an aspiring company which aims to bring people and technology together 
        with a commitment to seamless user experience and exceptional customer service.`}
          </span>
          <span className="text-content">
